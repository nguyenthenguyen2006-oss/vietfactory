    ...
    >
      ...
      >
        ...
        <div className="relative h-44 overflow-hidden md:h-52">
          ...
          <div className="absolute inset-0 bg-yellow/0 transition-colors duration-500 group-hover:bg-yellow/8" />
        </div>

        {/* Engineering index - large ghost on hover */}
        <div
          className="pointer-events-none absolute right-4 top-4 z-0 font-bold transition-all duration-500 group-hover:text-yellow/15"
          style={{
        ...
        <div className="relative z-10 flex min-h-[200px] flex-col justify-end p-6 md:p-8">
          ...
          <span className="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-yellow opacity-0 transition-opacity duration-400 group-hover:opacity-100">
            Xem chi tiết
